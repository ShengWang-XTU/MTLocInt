...
for ipp = 1:length(pp)
    ...
    for ind = 1:length(seq)
        ...
        img = frame2im(frame);
        eval(['imwrite(img, "CGRxy_3D_Protein_136_AG_T\CGRxy_3D_136_', num2str(ind), '.png");']);
        close all
...
%         img = frame2im(frame);
%         eval(['imwrite(img, "CGRxz_3D_Protein_136_AG_T\CGRxz_3D_136_', num2str(ind), '.png");']);
%         close all
% 
%         figyz = figure;
%         plot(yu, zu, 'k.')
...
%         img = frame2im(frame);
%         eval(['imwrite(img, "CGRyz_3D_Protein_136_AG_T\CGRyz_3D_136_', num2str(ind), '.png");']);
%         close all
    end
end
toc